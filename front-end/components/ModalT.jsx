...
const Modal3 = ({ setModal3On, set3Choice }) => {
    ...
    const kategoriler = [
        { baslik: "Felsefe", id: "0" },
        { baslik: "Bilim Kurgu", id: "1" },
        { baslik: "Teknoloji", id: "2" },
        { baslik: "Bilim", id: "3" },
        { baslik: "Sanat", id: "4" },
        { baslik: "Müzik", id: "5" },
        { baslik: "Programlama", id: "6" },
        { baslik: "Biyoloji", id: "7" },
        { baslik: "Fizik", id: "8" },
        { baslik: "Kimya", id: "9" },
        { baslik: "Matematik", id: "10" },
        { baslik: "Evrim", id: "11" },
        { baslik: "Havacılık", id: "12" },
        { baslik: "Coğrafya", id: "13" },
        { baslik: "Film İncelemesi", id: "14" },
        { baslik: "Bilgisayar Bilimleri", id: "15" },
        { baslik: "Kripto", id: "16" },
      ]
            ...
            <div className="flex h-screen op justify-center items-center ">
                ...
                <div className="flex-col justify-center bg-slate-800 border-2 border-slate-700 border-dashed rounded-xl ">
                    ...
                    <div className="font-poppins flex w-auto m-3 h-auto">
                        ...
                        <h3 class="mb-4 font-semibold text-gray-900 dark:text-white">Etiketler</h3>
