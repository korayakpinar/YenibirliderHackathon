      ...
      <div className='p-10 h-full sticky mt-[80px]'>
        ...
        <div className='w-400 h-150 m-auto bg-slate-800 rounded-xl flex justify-between p-4 mt-2'>
          <div>
            ...
            <p className='font-poppins dark:text-white max-w-xs text-xs'>
              ...
              using Tailwind CSS for the styling. Lots of really cool features
              in Next JS - most known for server side rending, lazy loading
              images, and a built in routing system. We won't be utilizing
              server side rending in this particular build, however we do
              incorporate lazy loading images as well as the built in router.
              (Just to be clear to take advantage of lazy loading you must use
              the "Image" component imported from next/image. Images used as
              "img" will not be lazy loaded. Thanks for following along!
            </p>
            {modal1On && (
        ...
        <div>
          <div className=' max-w-sm h-150  bg-slate-700 rounded-xl flex justify-between p-4 mt-2'>
            <div
              onClick={clicked3}
              className=' fixed z-50 absolute right-12 bg-slate-600 border-2 border-slate-500 border-dashed rounded-full p-2 max-h-9 w-max flex-row items-center cursor-pointer hover:scale-105 ease-in duration-100'
            >
              <FaEdit className='text-white' />
            </div>
            {modal3On && (
